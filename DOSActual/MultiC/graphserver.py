...
class Graph(graph_pb2_grpc.GraphServicer):
    ...
    def addVertex(self, request, context):
        ...
        print(f"Vertex {v} has been added.")
    ...
    def addEdge(self, request, context):
        ...
        print(f"Edge: {v0} -> {v1} has been added.")
    ...
    def shortestPath(self, request, context):
        ...
        while queue:
            ...
            if(current not in self.graph):
                print(f"Vertex {current} does not exist in graph.")
                logging.warning("Vertex does not exist in graph.")
                continue
    ...
    def Shutdown(self, request, context):
        with self.lock:
            ...
            if(self.clients==0):
                ...
                print(f"One down. Still: {self.clients} left.")
                return(graph_pb2.Response(message="One down. Still going strong."))
            
    def ClientConnect(self, request, context):
        with self.lock:
            self.clients+=1
        print(f"A new friend. {self.clients} Friends total.")
        return(graph_pb2.Response(message="A new companion has appeared."))
