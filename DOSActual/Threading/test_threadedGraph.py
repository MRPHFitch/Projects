...
def test_remove_vertex():
    ...
    assert g.remove_vertex("A") == "Fail: Vertex A could not be removed. It had friends."
    assert g.remove_vertex("B") == "Success: Vertex B removed."
    assert g.has_edge("A", "B") == "Fail: Edge (A, B) does not exist."
    assert g.remove_vertex("A") == "Success: Vertex A removed."
