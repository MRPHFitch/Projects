...
class GraphStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getAllVertices = channel.unary_unary(
                ...
                response_deserializer=broker__pb2.getAllResponse.FromString,
        ...
        self.addVertex = channel.unary_unary(
                ...
                request_serializer=broker__pb2.Vertex.SerializeToString,
                response_deserializer=broker__pb2.Response.FromString,
                _registered_method=True)
        self.addEdge = channel.unary_unary(
                '/Graph.Graph/addEdge',
                request_serializer=broker__pb2.Edge.SerializeToString,
                response_deserializer=broker__pb2.EdgeResponse.FromString,
                _registered_method=True)
        ...
        self.hasVertex = channel.unary_unary(
                ...
                request_serializer=broker__pb2.Vertex.SerializeToString,
                response_deserializer=broker__pb2.YesNo.FromString,
                _registered_method=True)
        ...
        self.hasPath = channel.unary_unary(
                '/Graph.Graph/hasPath',
                request_serializer=broker__pb2.EdgeList.SerializeToString,
                response_deserializer=broker__pb2.YesNo.FromString,
                _registered_method=True)
        self.getPath = channel.unary_unary(
                '/Graph.Graph/getPath',
                request_serializer=broker__pb2.Edge.SerializeToString,
                response_deserializer=broker__pb2.Multiple.FromString,
                _registered_method=True)
...
def add_GraphServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getAllVertices': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=broker__pb2.getAllResponse.SerializeToString,
            ),
            ...
            'addVertex': grpc.unary_unary_rpc_method_handler(
                    servicer.addVertex,
                    request_deserializer=broker__pb2.Vertex.FromString,
                    response_serializer=broker__pb2.Response.SerializeToString,
            ),
            'addEdge': grpc.unary_unary_rpc_method_handler(
                    servicer.addEdge,
                    request_deserializer=broker__pb2.Edge.FromString,
                    response_serializer=broker__pb2.EdgeResponse.SerializeToString,
            ),
            ...
            'hasVertex': grpc.unary_unary_rpc_method_handler(
                    servicer.hasVertex,
                    request_deserializer=broker__pb2.Vertex.FromString,
                    response_serializer=broker__pb2.YesNo.SerializeToString,
            ),
            ...
            'hasPath': grpc.unary_unary_rpc_method_handler(
                    servicer.hasPath,
                    request_deserializer=broker__pb2.EdgeList.FromString,
                    response_serializer=broker__pb2.YesNo.SerializeToString,
            ),
            'getPath': grpc.unary_unary_rpc_method_handler(
                    servicer.getPath,
                    request_deserializer=broker__pb2.Edge.FromString,
                    response_serializer=broker__pb2.Multiple.SerializeToString,
            ),
...
class Graph(object):
    ...
    def getAllVertices(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            broker__pb2.getAllResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def addVertex(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Graph.Graph/addVertex',
            broker__pb2.Vertex.SerializeToString,
            broker__pb2.Response.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def addEdge(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Graph.Graph/addEdge',
            broker__pb2.Edge.SerializeToString,
            broker__pb2.EdgeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def hasPath(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Graph.Graph/hasPath',
            broker__pb2.EdgeList.SerializeToString,
            broker__pb2.YesNo.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def getPath(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/Graph.Graph/getPath',
            broker__pb2.Edge.SerializeToString,
            broker__pb2.Multiple.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class BrokerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.hasPath = channel.unary_unary(
                '/Graph.Broker/hasPath',
                request_serializer=broker__pb2.EdgeList.SerializeToString,
                response_deserializer=broker__pb2.YesNo.FromString,
                _registered_method=True)
        self.getPath = channel.unary_unary(
                '/Graph.Broker/getPath',
                request_serializer=broker__pb2.Edge.SerializeToString,
                response_deserializer=broker__pb2.Multiple.FromString,
                _registered_method=True)
        self.shortestPath = channel.unary_unary(
                '/Graph.Broker/shortestPath',
                request_serializer=broker__pb2.Edge.SerializeToString,
                response_deserializer=broker__pb2.Multiple.FromString,
                _registered_method=True)
        self.getAllVertices = channel.unary_unary(
                '/Graph.Broker/getAllVertices',
                request_serializer=broker__pb2.Empty.SerializeToString,
                response_deserializer=broker__pb2.getAllResponse.FromString,
                _registered_method=True)
        self.getAllEdges = channel.unary_unary(
                '/Graph.Broker/getAllEdges',
                request_serializer=broker__pb2.Empty.SerializeToString,
                response_deserializer=broker__pb2.getAllResponse.FromString,
                _registered_method=True)
        self.addVertex = channel.unary_unary(
                '/Graph.Broker/addVertex',
                request_serializer=broker__pb2.Vertex.SerializeToString,
                response_deserializer=broker__pb2.Response.FromString,
                _registered_method=True)
        self.addEdge = channel.unary_unary(
                '/Graph.Broker/addEdge',
                request_serializer=broker__pb2.Edge.SerializeToString,
                response_deserializer=broker__pb2.EdgeResponse.FromString,
                _registered_method=True)
        self.removeVertex = channel.unary_unary(
                '/Graph.Broker/removeVertex',
                request_serializer=broker__pb2.Vertex.SerializeToString,
                response_deserializer=broker__pb2.Response.FromString,
                _registered_method=True)
        self.removeEdge = channel.unary_unary(
                '/Graph.Broker/removeEdge',
                request_serializer=broker__pb2.Edge.SerializeToString,
                response_deserializer=broker__pb2.Response.FromString,
                _registered_method=True)
        self.hasVertex = channel.unary_unary(
                '/Graph.Broker/hasVertex',
                request_serializer=broker__pb2.Vertex.SerializeToString,
                response_deserializer=broker__pb2.YesNo.FromString,
                _registered_method=True)
        self.hasEdge = channel.unary_unary(
                '/Graph.Broker/hasEdge',
                request_serializer=broker__pb2.Edge.SerializeToString,
                response_deserializer=broker__pb2.YesNo.FromString,
                _registered_method=True)
        self.getNeighbors = channel.unary_unary(
                '/Graph.Broker/getNeighbors',
                request_serializer=broker__pb2.Vertex.SerializeToString,
                response_deserializer=broker__pb2.getAllResponse.FromString,
                _registered_method=True)
        self.printGraph = channel.unary_unary(
                '/Graph.Broker/printGraph',
                request_serializer=broker__pb2.Empty.SerializeToString,
                response_deserializer=broker__pb2.getAllResponse.FromString,
                _registered_method=True)
        self.Shutdown = channel.unary_unary(
                '/Graph.Broker/Shutdown',
                request_serializer=broker__pb2.Empty.SerializeToString,
                response_deserializer=broker__pb2.Response.FromString,
                _registered_method=True)
...
def add_BrokerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'Graph.Broker', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Graph.Broker', rpc_method_handlers)
